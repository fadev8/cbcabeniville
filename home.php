            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section-heading">
                        <h2>Bienvenu A l'&eacute;glise</h2>
    ...
    <section class="call-to-action-area section-padding-100 bg-img bg-overlay" style="background-image: url(img/bg-img/6.jpg)">
        <div class="container">
            <?php
            	include_once('shared/findaplace.php');
            ?>
        </div>
    </section>
    ...
    <section class="latest-sermons-area section-padding-100-0">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section-heading">
                        <h2>Pr&eacute;dications recentes</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="section-heading text-left white">
                            <h2>Ev&eacute;nements A venir</h2>
                            <p>
                            	Pour toute actualit&eacute;, visitez r&eacute;guli&egrave;rement la page de nos Ev&eacute;nements.
                            </p>
                        </div>
                    </div>
                </div>
