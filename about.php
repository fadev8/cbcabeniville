            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-12 col-lg-5">
                    <div class="about-content">
                        <h2 class="text-center">Bienvenu à la <br> CBCA Francophone Beni</h2>
                        ...
                        <div class="opening-hours-location mt-30 d-flex align-items-center">
                            ...
                            <div class="opening-hours">
                                ...
                                <p>Lun - Samedi de 09:00 - 17:00 <br>Dim de 7:00 - 14:00</p>
                            </div>
                            <!-- Location -->
                            <div class="location">
                                <h6><i class="fa fa-map-marker"></i> Adresse</h6>
                                <p>Q. Residentiel, Bungulu Beni</p>
                                <p>Avant le bureau de la commune Bungulu</p>
                            </div>
                        </div>
                    </div>
                </div>
